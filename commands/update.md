...
**Skip this step if mode is `sdk`.** If the plugin was updated, remind the user to restart Claude Code to apply the update. If the mode was `plugin`, stop here — do not run steps 3-9.
